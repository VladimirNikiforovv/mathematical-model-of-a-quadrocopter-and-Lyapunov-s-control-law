...
class quadrocopter:
    ...
    def motion_simulation(self, h, N, w_init, q_init, p_init, r_init):
        ...
        """Определение углового ускорения создоаваемого винтами"""
    ...
    def simulation_animate(self):
        ...
        """отрисовка фигуры креста квадракоптера """
        ...
        for i in range(0, self.N):
            ...
            q2 = self.qq[2,i]
            q3 = self.qq[3,i]
            """расчет матрици направляющих косинусов через кватернионы"""
        ...
        self.line_ani_1 = animation.FuncAnimation(self.fig, animate_func_ang, interval=1, frames=round(self.N))
        self.ax2 = self.fig.add_subplot(1, 2, 2, projection='3d')
        self.line_ani_2 = animation.FuncAnimation(self.fig, animate_func_tr, interval=1, frames=round(self.N))
        plt.show()
        
    def motion_pattern_graph(self):
        """вывод всех расчитанных функций движения"""
        t = np.linspace(0, self.h*self.N, self.N)
        self.fig2 = plt.figure()
        """Подграфик для Угловые скорости""" 
        ...
        """Подграфик для координат центральной точки"""
